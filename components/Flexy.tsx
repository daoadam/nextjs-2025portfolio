        ...
        >
            ...
            <div className=" bg-white rounded-[20px] overflow-hidden">
              <div className=" bg-[#ffffff] relative w-fill h-fit flex flex-col justify-items-center gap-[20px] p-[20px] shadow-amber-600 shadow-md hover:shadow-[hsla(220,100%,61%,1)] hover:shadow-lg transition-transform duration-200">
                <div className="flex flex-col justify-start items-start h-fit w-full gap-[10px] ">
                  ...
                  <div className="font-medium text-[#000000] text-[15px]  gap-[10px]">
                    <Link href="/wherenow">Next: WhereNow</Link>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className=" relative w-[100%] xl:w-[75%] flex flex-col justify-center item-center gap-[20px]  ">
            ...
            >
              ...
              <p className="font-medium text-[#312121] text-[15px] flex flex-col gap-[10px] tracking-[-0.2px] leading-[1.2]">
                After displaying the mock-up to 20 students, 75% of them could
                see this helping their life and providing a meaningful service.
              </p>
              ...
              <div className="bg-[#fcf9f2] rounded-[16px]  relative w-full h-fit flex flex-col justify-items-center gap-[10px] p-[20px] ">
                <ul className="font-medium text-[#9c8f6d] text-[15px] flex flex-col gap-[10px] px-[20px] tracking-[-0.2px] leading-[1.2] list-decimal items-start">
                  <li>
                    We designed Flexy with users in mind, making sure booking
                    feels smooth and easy. People don’t want to deal with
                    complicated systems—they just want to book an appointment
                    without hassle. Real-time updates and reminders help avoid
                    confusion and build trust between clients and providers.
                  </li>
                  <li>
                    Flexibility and automation were huge in solving common
                    booking issues. One-tap cancellations and automated
                    reminders made things easier for both clients and
                    businesses, cutting down no-shows. Providers still need
                    control over their schedules, but clients also want the
                    freedom to reschedule easily, so finding the right balance
                    was important.
                  </li>

                  <li>
                    Testing and feedback played a big role in improving Flexy.
                    Listening to real users helped us refine appointment
                    handling, financial tracking, and the overall experience.
                    Moving forward, we’ll focus on making Flexy even more
                    personalized, adding better tools for providers, and making
                    sure it works seamlessly across different platforms
                  </li>
                </ul>
              </div>
            </div>
